...
#[openapi(
    paths(
        ...
        super::routes::config_management::get_extension_groups,
        super::routes::config_management::add_extension_group,
        super::routes::config_management::remove_extension_group,
    ...
    components(schemas(
        ...
        super::routes::config_management::ExtensionGroupsResponse,
        super::routes::config_management::ExtensionGroupQuery,
        goose::config::extensions::ExtensionGroup,
